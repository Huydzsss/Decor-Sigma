...
export default function Service(){
    return(
        <div>
             <div className="product-banner-area section-bottom-space">
  <div className="container">
    <div className="swiper-container-wrap swiper-button-style swiper-button-nav1">
      {/*== Start Swiper Navigation ==*/}
      <div className="swiper-button-prev" />
      <div className="swiper-button-next" />
      <div className="swiper product-banner-slider swiper-shadow-space">
