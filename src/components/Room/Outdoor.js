    ...
    return (
        <div>
            ...
            <div className="page-header-area">
                <div className="page-header-content bg-img" data-bg-img="https://images.pexels.com/photos/14656123/pexels-photo-14656123.jpeg?auto=compress&cs=tinysrgb&h=627&fit=crop&w=1200">
                    <ol className="breadcrumb">
                        <li className="breadcrumb-item" ><a href="/">Home</a></li>
                        <li className="breadcrumb-item active "  aria-current="/Outdoor">Out door</li>
                    </ol>
                </div>
            </div>
