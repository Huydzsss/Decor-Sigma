    ...
    return (
        <div>
            ...
            <div className="page-header-area">
                <div className="page-header-content bg-img" data-bg-img="https://sketchup.cgtips.org/wp-content/uploads/2023/10/11247.-Sketchup-Model-Of-Kitchen-Interior-For-Free-Download-By-Ravi-K-3-1536x864.jpg">
                    <ol className="breadcrumb">
                        <li className="breadcrumb-item" ><a href="/">Home</a></li>
                        <li className="breadcrumb-item active "  aria-current="/Kitchen">Kitchen</li>
                    </ol>
                </div>
            </div>
