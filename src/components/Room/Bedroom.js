    ...
    return (
        <div>
            ...
            <div className="page-header-area">
                <div className="page-header-content bg-img" data-bg-img="https://donggia.vn/wp-content/uploads/2021/04/Phong-ngu-con-3.jpg">
                    <ol className="breadcrumb">
                        <li className="breadcrumb-item" ><a href="/">Home</a></li>
                        <li className="breadcrumb-item active "  aria-current="/Bedroom">Bedroom</li>
                    </ol>
                </div>
            </div>
