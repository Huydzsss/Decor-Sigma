    ...
    return (
        <div>
            ...
            <div className="page-header-area">
                <div className="page-header-content bg-img" data-bg-img="https://roohome.com/wp-content/uploads/2017/03/Tu-Nguyen-Hoang1.jpg">
                    <ol className="breadcrumb">
                        <li className="breadcrumb-item" ><a href="/">Home</a></li>
                        <li className="breadcrumb-item active "  aria-current="/Lounge">Lounge</li>
                    </ol>
                </div>
            </div>
